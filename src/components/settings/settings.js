      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.body}>
          ...
          <View style={{marginTop: 12}}>
            ...
            <View style={{backgroundColor: '#FFFFFF', paddingLeft: 15}}>
              <Picker
                placeholder="Edit My Info"
                placeholderTextColor="#BFBFBF"
                style={styles.picker}
                textStyle={styles.pickerText}
                selectedValue={this.state.editMyInfo}
                onValueChange={(editMyInfo) => this.setState({editMyInfo})}
                items={[{label: 'Edit My Info', value: 'Edit My Info'}]}
                />
            </View>
          </View>
