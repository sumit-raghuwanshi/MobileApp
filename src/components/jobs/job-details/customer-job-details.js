...
class CustomerJobDetails extends Component {
  ...
  constructor(props) {
    ...
    this._navigateToInvoiceScreen = this._navigateToInvoiceScreen.bind(this)
    this._navigateToChatScreen = this._navigateToChatScreen.bind(this)
   this._navigateToPaymentsScreen = this._navigateToPaymentsScreen.bind(this)
  }
      ...
      <View style={styles.container}>
        ...
        <SafeAreaView style={styles.header}>
          ...
          <View style={styles.safeAreaView}>
            ...
            <Text style={styles.safeAreaText}>JOB INFORMATION</Text>
          </View>
        ...
        <ScrollView style={styles.body}>
          ...
          {/* <Modal style = {{backgroundColor : "transparent"}} visible = {this.state.isModalVisible} onRequestClose = { () => console.log("test modal")}>
           ...
           <View style={{ flexDirection: 'row', backgroundColor : "#FFFFFF", height : 40 , justifyContent : "center" , alignItems : "center" , paddingLeft : 10 , paddingRight : 10}}>
                <View style={styles.buttonContainers}>
                    <Touchable onPress={this._navigateToChatScreen} >
          ...
          <View style={{ flexDirection: 'row', backgroundColor : "#FFFFFF", height : 40 , justifyContent : "center" , alignItems : "center" , paddingLeft : 10 , paddingRight : 10}}>
                <View style={styles.buttonContainers}>
                    <Touchable onPress={this._Estimate}>
          ...
          <View style={{ flexDirection: 'row', backgroundColor : "#FFFFFF", height : 40 , justifyContent : "center" , alignItems : "center" , paddingLeft : 10 , paddingRight : 10}}>
                <View style={styles.buttonContainers}>
                    <Touchable onPress={this._navigateToInvoiceScreen}>
                        <Text style = {{fontWeight : 'bold'}}>Invoices</Text>
                    </Touchable>
                </View>
          </View>
          <View style={{ flexDirection: 'row', backgroundColor : "#FFFFFF", height : 40 , justifyContent : "center" , alignItems : "center" , paddingLeft : 10 , paddingRight : 10}}>
...
export default connect(mapStateToProps, {createLead, getUserList , getParticularJob , updateJobStatus})(CustomerJobDetails);