...
import {getCustomerUserList} from '../../actions';
...
class Users extends Component {
  ...
  componentDidMount() {
    (this.props.user.role !== "Customer" ? this.props.getCustomerUserList() : this.props.getCustomerUserList()).then((response) => {
  ...
  async callBack(){
    this.props.getCustomerUserList()
    .then((response) => {
      ...
      <View style={styles.container}>
        ...
        <SafeAreaView style={styles.header}>
          ...
          <View style={styles.safeAreaView}>
            ...
            <Text style={styles.safeAreaText}>Users</Text>
          </View>
...
export default connect(mapStateToProps, {getCustomerUserList})(Users)
